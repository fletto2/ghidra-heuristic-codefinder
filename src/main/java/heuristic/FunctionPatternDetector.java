...
public class FunctionPatternDetector {
	...
	public List<FunctionType> classify(Function function) {
		...
		// Universal detectors — run for all ROM types
		...
		// Game/arcade-specific detectors — only run when ROM is confirmed
		// as a game console cartridge or arcade board
		boolean isGame = (romDomain == PcodeVectorDatabase.RomDomain.GAME_CONSOLE ||
		                  romDomain == PcodeVectorDatabase.RomDomain.ARCADE);
		if (isGame) {
