...
10. **Function classification** — 132 rule-based detectors + 126 feature-vector signatures classify functions by algorithmic purpose (memcpy, checksum, decompression, sprite renderer, I2C, FFT, FAT filesystem, etc.) and label hardware register accesses
...
- **Pass 10** (132 detectors + 126 signatures): Function pattern classification via P-code operation distribution analysis
